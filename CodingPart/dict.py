...
dictionary11= {
      "ssc": ["10th"],
      "hsc": ["12th"],
      "grad":["graduation","grad","Grad","Graduation"],
      "age":["age","Age","AGE"],
      "OR": ["or","OR"],
      ...
      "name":['names',"name's"],
      "*":["all","detail","every","completely","fully","thoroughly","entir","altogether","whole","information"],
...
dictionary3={
        ...
        ">":['greater','greater than','more','more than','above'],
        "=":['equal'],
        "* FROM":['*<keyword>']
        }
